/* These are all the solutions I used for String1 on codingbat.com. They are great practice questions for getting into java. Most of these can be reworked and made more efficient or generally better. */
public class String1 {
	...
	public String twoChar(String str, int index) {
		if (index+2>str.length()||index>str.length()||index<0){
			return str.substring(0,2);
		}else{
	...
	public boolean frontAgain(String str) {
		if(str.length()>1) return (str.substring(0,2).equals(str.substring(str.length()-2, str.length())));
		else return false;
	}
	
	/* Given two strings, append them together (known as "concatenation") and return the result. However, if the strings are different lengths, omit chars from the longer string so it is the same length as the shorter string. 
